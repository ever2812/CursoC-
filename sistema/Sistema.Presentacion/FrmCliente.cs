    ...
    public partial class frmCliente : Form
    {
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rpta = NPersona.Insertar("Cliente",txtNombre.Text.Trim(), cboTipoDocumento.Text, txtNumDocumento.Text.Trim(), txtDireccion.Text, txtTelefono.Text.Trim(), txtEmail.Text.Trim());
                    if (rpta.Equals("OK"))
                    {
